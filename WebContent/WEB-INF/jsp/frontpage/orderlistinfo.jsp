...
<div class="content shop_line_pag">
    <div class="local">
        <a href="#">首页</a> \ <a href="#">兑换详情</a><i class="fa fa-arrow-left"></i>
    </div>
    <div class="shop_line">
...
<table width="1000" border="0" align="center">
 ...
 <tr>
   <input type="hidden" name="id" value="${good.id}" />
    ...
    <td bgcolor="#EFEFFF">${good.nums }</td>
    <td bgcolor="#EFEFFF">${good.goodsprice*good.nums }</td>
  </tr>
  </c:forEach>
  </c:if>
