			...
			<br/>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="${pageContext.request.contextPath }/addgoods.action">
																<i class="ace-icon fa fa-check bigger-120"></i>
															</button>

<a href="${pageContext.request.contextPath }/editgoods.action?id=${good.id}"><button class="btn btn-xs btn-info">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</button></a>
															

															<button class="btn btn-xs btn-danger">
															<a href="${pageContext.request.contextPath }/deletegoods.action?id=${good.id}">
