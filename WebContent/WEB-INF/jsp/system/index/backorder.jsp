...
<!-- 						</div> -->
						...
						<div>
<!-- 							<iframe name="mainFrame" id="mainFrame" frameborder="0" src="goshopping.action" style="margin:0 auto;width:100%;height:100%;"></iframe> -->
						</div>
										...
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<c:forEach items="${orderCustoms }" var="order">
												<tr>
													...
													<td class="hidden-480"><fmt:formatDate value="${order.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<button class="btn btn-xs btn-info">
																<a href="${pageContext.request.contextPath }/editorder.action?id=${order.id}"><i class="ace-icon fa fa-pencil bigger-120"></i>
															</button>
...
<!-- 													<td class="hidden-480">2017-04-26  20：55：05</td> -->
