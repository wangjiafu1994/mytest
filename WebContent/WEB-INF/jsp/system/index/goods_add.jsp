		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="${pageContext.request.contextPath }/addgoodssubmit.action" name="Form" id="Form" method="post" enctype="multipart/form-data">
							<div id="zhongxin" style="padding-top: 13px;">
							<table id="table_report" class="table table-striped table-bordered table-hover">
							<input type="hidden" name="id" value=""/>
								<tr>
									<td style="width:50px;text-align: right;padding-top: 13px;">商品名称:</td>
									<td><input type="text" name="goodsname" id="TITLE" value="" maxlength="32" style="width:99%;"/></td>
								</tr>
								<tr>
									<td style="width:50px;text-align: right;padding-top: 13px;">商品价格:</td>
									<td><input type="text" name="goodsprice" id="TITLE" value="" maxlength="32" style="width:99%;"/></td>
								</tr>
								<tr>
									<td style="width:50px;text-align: right;padding-top: 13px;">商品介绍:</td>
									<td><input type="text" name="goodsintro" id="TITLE" value="" maxlength="32" style="width:99%;"/></td>
								</tr>
								<tr>
									<td style="width:50px;text-align: right;padding-top: 13px;">商品数量:</td>
									<td><input type="text" name="goodsnum" id="TITLE" value="" maxlength="32" style="width:99%;"/></td>
								</tr>
								<tr>
									<td style="width:50px;text-align: right;padding-top: 13px;">积分值:</td>
									<td><input type="text" name="integral" id="TITLE" value="" maxlength="32" style="width:99%;"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="createtime" value="" maxlength="32" style="width:99% class="Wdate"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  /></td>
								</tr>
								<tr>
