...
<body>
<form id="itemForm" action="${pageContext.request.contextPath }/editgoodssubmit.action" method="post" enctype="multipart/form-data">
...
<tr>
	...
	<td>
		<c:if test="${goodsCustom.pic !=null}">
			<img src="/pic/${goodsCustom.pic}" width=100 height=100/>
			<br/>
		</c:if>
...
<tr>
	<td>商品简介</td>
	<td>
	<textarea rows="3" cols="30" name="goodsintro">${goodsCustom.goodsintro }</textarea>
	</td>
</tr>
<tr>
