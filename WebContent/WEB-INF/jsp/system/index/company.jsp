										...
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												<tr>
													...
													<td> 欢迎光临本店，您的支持是我们最大的前进动力，本店所有产品均低价销售，并且保证质量，需要的亲请放心购买，我们一定会给您一个最舒心的购物体验！

  本店所有的专辑制作优良。</td>
													<td class="hidden-480"><img src="${pageContext.request.contextPath}/image/2.jpg"  width=100 height=100/></td>
